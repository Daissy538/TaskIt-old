...
namespace TaskItApi.Repositories
{
    ...
    {    
        ...
        public bool SubscribeUser(int groupID, int userID)
        {
            ...
            {
                throw new InvalidDataException($"User {userID} is already subscribed to the group {groupID}");
            }
        ...
        public bool UnSubscribeUser(int groupID, int userID)
        {
            ...
            {
                throw new InvalidDataException($"User {userID} is not subscribed for group {groupID}");
            }
